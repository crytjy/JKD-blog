            ...
            <form id="page-form-body" class="form-horizontal">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control ipt" id="url" name="url" value="" placeholder="链接">
                        </div>
                    </div>
                    <div class="form-group">
...
@section('bodyjs')
    <script>
        ...
        indexUrl = "{{ route('link')}}";
        updateUrl = "{{ route('link.update')}}";
        storeUrl = "{{ route('link.store')}}";

        $.ajaxSetup({headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')}});
    </script>

    <script src="{{ asset("/js/admin/link.js") }}"></script>
@stop
